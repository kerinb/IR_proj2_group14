...
public class FedRegister {
        ...
        for (File directory : directories) {
            ...
            for (File file : files) {
                ...
                for (Element document : documents) {
                    ...
                    addFedRegisterDoc(docno, text, usdepartment, agency, usbureau, title, address, further, summary, action, signer, signjob, supplem, billing, frfiling, date, crfno, rindock);
                }
            }
        }
    ...
    private static void addFedRegisterDoc(String docno, String text, String usdepartment, String agency, String usbureau, String title, String address, String further, String summary, String action, String signer, String signjob, String supplem, String billing, String frfiling, String date, String crfno, String rindock) {
