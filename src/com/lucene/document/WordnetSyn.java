...
//		//		qryList.add("woods");
//		//		qryList.add("car");
//		//		System.out.println(getSynonyms(qryList));
//		//		
//		//		String workingDir = System.getProperty("user.dir");
//		//		//build the index
//		//		String fileDir = workingDir.concat("/wordnet/wn_s.pl");
//		//		Syns2Index.main(new String[] { "wn_s.pl", "/LuceneSearchEnginer/src/main/java/com/lucene/document/WordnetSyn.java" });
//		//
//		//		
//		//		//expandQuery("big dog");
//		//		
//		//		
//		//		
//		//		WordnetSynonymParser parse = new WordnetSynonymParser(true, true, new EnglishAnalyzer());
//		//		
//		//parse.
//
//				List<String> qryList = new ArrayList<>();
...
//
//		String expanded = getSynonyms(qryList);
	...
	public static String getSynonyms(String queryContent) throws FileNotFoundException, IOException {
		...
		{ 
			...
			if(synsArray.length > 1) {
				...
				for(int k=0;k<synsArray.length;k++) {
					//append its synonyms
